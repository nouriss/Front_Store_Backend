...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.update = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, user, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    UserStore.prototype.authenticate = function (firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, user, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_6 = _a.sent();
                        throw new Error("Could not authenticate user  ".concat(firstname, " Error: ").concat(error_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
