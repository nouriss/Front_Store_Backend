    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_4 = _a.sent();
                res.status(400);
                res.json("Couldn't delelte product ".concat(err_4));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var productRoutes = function (app) {
    ...
    app.post('/products', authenticate_1.verifyAuthToken, create);
    app.put('/products/:id', authenticate_1.verifyAuthToken, update);
    app["delete"]('/products/:id', authenticate_1.verifyAuthToken, destroy);
};
